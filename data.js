const data = [
    ...
    ['безобразие', //это реально форменное безобразие как тебе это удаеться? я уже 3 или 4 раз дополняю дата фаил этими несчастными 2 массивами и в очередной раз после синхронизации(пула их нет в дате)
    	[
