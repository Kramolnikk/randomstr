const data = [
    ['Привет и пошёл (Алг.1)', /*'Элемент №0 */ //[[ standartQV ] [QVtravel] или еще че то ],
        [
    ...
    ['Заметки в ежедневнике (Алг.3)', /*'Элемент №3 */ 
    	[
    ...
    ['Крохин Евгений', /*'Элемент №4 */
    	[
    		'Женя Крохин мега-программист, какие тут могуть быть варианты?'
    	] 
    ],
    ['безобразие', /*'Элемент №5 */ //это реально форменное безобразие как тебе это удаеться? я уже 3 или 4 раз дополняю дата фаил этими несчастными 2 массивами и в очередной раз после синхронизации(пула их нет в дате)
    	[
            'это форменное безобразие я и так чувствую себя ущербным а теперь еще и это!', 'да когда же это кончиться!'
    	] 
    ],
    ['мне некогда', /*'Элемент №6 */
        [
    ...
    ['типичный ответ 1', /*'Элемент №7 */ //пока просто для пробы
    	[
            '', '', '', '', '', 'эх', 'хм'
        ], 
        [
        ...
        [
            'я сделаю это', 'я понял вас', 'я выполню это'
        ]
    ]
]
/*        
